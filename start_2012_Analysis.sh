...
sample="GJets_400To400" analysisMode="central" nohup ${exe} ${toolsFolder}python/master_2012_cfg.py ${TQAFPath} &> GJets_400To400_central.log &
sample="GJets_400To400" analysisMode="JES_up" nohup ${exe} ${toolsFolder}python/master_2012_cfg.py ${TQAFPath} &> GJets_400To400_JES_up.log &
sample="GJets_400To400" analysisMode="JES_down" nohup ${exe} ${toolsFolder}python/master_2012_cfg.py ${TQAFPath} &> GJets_400To400_JES_down.log &
sample="GJets_400To400" analysisMode="PU_down" nohup ${exe} ${toolsFolder}python/master_2012_cfg.py ${TQAFPath} &> GJets_400To400_PU_down.log &
sample="GJets_400To400" analysisMode="PU_up" nohup ${exe} ${toolsFolder}python/master_2012_cfg.py ${TQAFPath} &> GJets_400To400_PU_up.log &
sample="GJets_400To400" analysisMode="BJet_down" nohup ${exe} ${toolsFolder}python/master_2012_cfg.py ${TQAFPath} &> GJets_400To400_BJet_down.log &
sample="GJets_400To400" analysisMode="BJet_up" nohup ${exe} ${toolsFolder}python/master_2012_cfg.py ${TQAFPath} &> GJets_400To400_BJet_up.log &
sample="GJets_400To400" analysisMode="LightJet_down" nohup ${exe} ${toolsFolder}python/master_2012_cfg.py ${TQAFPath} &> GJets_400To400_LightJet_down.log &
sample="GJets_400To400" analysisMode="LightJet_up" nohup ${exe} ${toolsFolder}python/master_2012_cfg.py ${TQAFPath} &> GJets_400To400_LightJet_up.log &
...
#other generators:
sample="TTJets-mcatnlo" analysisMode="PU_down" nohup ${exe} ${toolsFolder}python/master_2012_cfg.py ${TQAFPath} &> TTJets-mcatnlo_PU_down.log &
sample="TTJets-powheg" analysisMode="PU_down" nohup ${exe} ${toolsFolder}python/master_2012_cfg.py ${TQAFPath} &> TTJets-powheg_PU_down.log &
