...
datasetInfo['TTJets_PowhegPythia8_mtop1695'] = { "cross-section" : 831.76,               "NumberOfProcessedEvents" :39127230}
...
datasetInfo['TTJets_PowhegHerwigpp'] = { "cross-section" : 831.76,            "NumberOfProcessedEvents" :39411550}
...
datasetInfo['W4JetsToLNu'] = { "cross-section" : 524.2,                  "NumberOfProcessedEvents" :9170576}
...
datasetInfo['STbar_tW'] = { "cross-section" : 35.6,                      "NumberOfProcessedEvents" :998276}
...
datasetInfo['QCD_EMEnriched_50to80'] = { "cross-section" : 19800000 * 0.146,                          "NumberOfProcessedEvents" :22337070}
datasetInfo['QCD_EMEnriched_80to120'] = { "cross-section" : 2800000 * 0.125,                        "NumberOfProcessedEvents" :35841783}
datasetInfo['QCD_EMEnriched_120to170'] = { "cross-section" : 477000 * 0.132,                        "NumberOfProcessedEvents" :35817281}
...
datasetInfo['QCD_bcToE_80to170'] = { "cross-section" : 3221000 * 0.01183,                           "NumberOfProcessedEvents" :3468225}
...
datasetInfo['QCD_MuEnriched_170to300'] = { "cross-section" : 117989 * 0.07335,                     "NumberOfProcessedEvents" :7947159}
datasetInfo['QCD_MuEnriched_300to470'] = { "cross-section" : 7820.25 * 0.10196,                     "NumberOfProcessedEvents" :7937590}
datasetInfo['QCD_MuEnriched_470to600'] = { "cross-section" : 645.528 * 0.12242,                     "NumberOfProcessedEvents" :3851524}
datasetInfo['QCD_MuEnriched_600to800'] = { "cross-section" : 187.109 * 0.13412,                     "NumberOfProcessedEvents" :4010136}
datasetInfo['QCD_MuEnriched_800to1000'] = { "cross-section" : 32.3486 * 0.14552,                     "NumberOfProcessedEvents" :3962749}
datasetInfo['QCD_MuEnriched_1000toInf'] = { "cross-section" : 10.4305 * 0.15544,                     "NumberOfProcessedEvents" :3695731}
