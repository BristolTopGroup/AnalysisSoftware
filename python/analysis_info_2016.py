...
datasets_13TeV = {
    ...
    'SingleElectron_Run2016B' : [ '/hdfs/TopQuarkGroup/ec6821/ntuple/v0.0.8/Spring16/SingleElectron_Run2016B_PromptReco_v2/tmp/'],
    'SingleElectron_Run2016C' : [ '/hdfs/TopQuarkGroup/ec6821/ntuple/v0.0.8/Spring16/SingleElectron_Run2016C_PromptReco_v2/tmp/'],
    'SingleElectron_Run2016D' : [ '/hdfs/TopQuarkGroup/ec6821/ntuple/v0.0.8/Spring16/SingleElectron_Run2016D_PromptReco_v2/tmp/'],
    ...
    'QCD_EMEnriched_15to20' : ['/hdfs/TopQuarkGroup/ec6821/ntuple/v0.0.8/Spring16/QCD_EMEnriched_15to20/tmp/'],
    'QCD_EMEnriched_20to30' : ['/hdfs/TopQuarkGroup/ec6821/ntuple/v0.0.8/Spring16/QCD_EMEnriched_20to30/tmp/'],
    'QCD_EMEnriched_30to50' : ['/hdfs/TopQuarkGroup/ec6821/ntuple/v0.0.8/Spring16/QCD_EMEnriched_30to50/tmp/'],
    'QCD_EMEnriched_50to80' : ['/hdfs/TopQuarkGroup/ec6821/ntuple/v0.0.8/Spring16/QCD_EMEnriched_50to80/tmp/'],
    'QCD_EMEnriched_80to120' : ['/hdfs/TopQuarkGroup/ec6821/ntuple/v0.0.8/Spring16/QCD_EMEnriched_80to120/tmp/'],
    'QCD_EMEnriched_120to170' : ['/hdfs/TopQuarkGroup/ec6821/ntuple/v0.0.8/Spring16/QCD_EMEnriched_120to170/tmp/'],
    'QCD_EMEnriched_170to300' : ['/hdfs/TopQuarkGroup/ec6821/ntuple/v0.0.8/Spring16/QCD_EMEnriched_170to300/tmp/'],
    'QCD_EMEnriched_300toInf' : ['/hdfs/TopQuarkGroup/ec6821/ntuple/v0.0.8/Spring16/QCD_EMEnriched_300toInf/tmp/'],

    # 'QCD_bcToE_15to20' : [mc_path_13TeV + 'QCD_bcToE_15to20/tmp/'],
    # 'QCD_bcToE_20to30' : [mc_path_13TeV + 'QCD_bcToE_20to30/tmp/'],
    'QCD_bcToE_30to80' : ['/hdfs/TopQuarkGroup/ec6821/ntuple/v0.0.8/Spring16/QCD_bcToE_30to80/tmp/'],
    'QCD_bcToE_80to170' : ['/hdfs/TopQuarkGroup/ec6821/ntuple/v0.0.8/Spring16/QCD_bcToE_80to170/tmp/'],
    # 'QCD_bcToE_170to250' : [mc_path_13TeV + 'QCD_bcToE_170to250/tmp/'],
    'QCD_bcToE_250toInf' : ['/hdfs/TopQuarkGroup/ec6821/ntuple/v0.0.8/Spring16/QCD_bcToE_250toInf/tmp/'],
