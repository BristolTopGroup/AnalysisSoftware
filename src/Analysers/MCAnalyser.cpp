...
//	if (ejets_event) cout << "e+jets event\n";
//	if (fully_leptonic_event) cout <<"fully leptonic\n";
//	if (fully_hadronic_event) cout << "fully hadronic\n";

	if (ejets_event) {
//		e_plus_jets_event = true;
...
//			total_event_number++;
//			if ((deltaRElectron<dr_treshold) and (deltaRLeptonicBjet<dr_treshold) and (deltaRHadronicBjet<dr_treshold) and (deltaRjet1fromW<dr_treshold) and (deltaRjet2fromW<dr_treshold)) {
//				reconstructed_correctly_number++;
		}
	}
}
