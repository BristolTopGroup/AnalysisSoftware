...
//	isPFMuonReader(input, MuonAlgorithm::prefixes.at(algo) + ".isPFMuon"),
...
//	PixelLayersWithMeasurement(input, MuonAlgorithm::prefixes.at(algo) + ".InnerTrack.TrackerLayersWithMeasurement"),
