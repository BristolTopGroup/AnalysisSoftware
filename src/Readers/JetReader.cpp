...
void JetReader::initialise() {
	...
	matchedPartonEnergyReader.initialiseBlindly();
	matchedPartonPxReader.initialiseBlindly();
	matchedPartonPyReader.initialiseBlindly();
	matchedPartonPzReader.initialiseBlindly();
	matchedPartonPdgIdReader.initialiseBlindly();
