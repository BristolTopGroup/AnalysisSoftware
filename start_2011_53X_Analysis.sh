...
#sample="QCD_Mu" analysisMode="JetSmearing_up" nohup ${exe} ${toolsFolder}python/master_2011_53X_cfg.py ${TQAFPath} &> QCD_Mu_JER_up.log &
#sample="QCD_Mu" analysisMode="JetSmearing_down" nohup ${exe} ${toolsFolder}python/master_2011_53X_cfg.py ${TQAFPath} &> QCD_Mu_JER_down.log &
...
#sample="TTbarZIncl" analysisMode="JetSmearing_up" nohup ${exe} ${toolsFolder}python/master_2011_53X_cfg.py ${TQAFPath} &> TTbarZIncl_JER_up.log &
#sample="TTbarZIncl" analysisMode="JetSmearing_down" nohup ${exe} ${toolsFolder}python/master_2011_53X_cfg.py ${TQAFPath} &> TTbarZIncl_JER_down.log &
...
#sample="TTbarInclWIncl" analysisMode="JetSmearing_up" nohup ${exe} ${toolsFolder}python/master_2011_53X_cfg.py ${TQAFPath} &> TTbarInclWIncl_JER_up.log &
#sample="TTbarInclWIncl" analysisMode="JetSmearing_down" nohup ${exe} ${toolsFolder}python/master_2011_53X_cfg.py ${TQAFPath} &> TTbarInclWIncl_JER_down.log &
...
#sample="WW" analysisMode="JetSmearing_up" nohup ${exe} ${toolsFolder}python/master_2011_53X_cfg.py ${TQAFPath} &> WW_JER_up.log &
#sample="WW" analysisMode="JetSmearing_down" nohup ${exe} ${toolsFolder}python/master_2011_53X_cfg.py ${TQAFPath} &> WW_JER_down.log &
...
#sample="WZ" analysisMode="JetSmearing_up" nohup ${exe} ${toolsFolder}python/master_2011_53X_cfg.py ${TQAFPath} &> WZ_JER_up.log &
#sample="WZ" analysisMode="JetSmearing_down" nohup ${exe} ${toolsFolder}python/master_2011_53X_cfg.py ${TQAFPath} &> WZ_JER_down.log &
...
#sample="ZZ" analysisMode="JetSmearing_up" nohup ${exe} ${toolsFolder}python/master_2011_53X_cfg.py ${TQAFPath} &> ZZ_JER_up.log &
#sample="ZZ" analysisMode="JetSmearing_down" nohup ${exe} ${toolsFolder}python/master_2011_53X_cfg.py ${TQAFPath} &> ZZ_JER_down.log &
