...
public:
	...
	double weight(const JetCollection jets, const int systematic, const std::vector<std::string> bJetWPs, double& efficiencyCorrection, double& alternativeWeight) const;
