...
#include "../TTreeHelpers/TTreeManager.h"
#include "../Event.h"
...
public:
	...
	BasicAnalyser(HistogramManagerPtr histMan, TTreeManagerPtr tTreeMan, std::string histogramFolder = "BasicAnalyser");
