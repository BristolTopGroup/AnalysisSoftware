...
#    qcdScale = {'default':1, 'withMETAndAsymJets': 1.};
    ...
    data = TFile.Open("/storage/results/histogramFiles/ElectronHad_715.09pb_PFElectron_PF2PATJets_PFMET.root");
...
#    hists.append('topReconstruction/backgroundShape/mttbar_antiID')
